...
#[lua_func(name = "setTimeout", skip = "lua", module = "waypane")]
#[arg(
    name = "callback",
    doc = "The callback to call after `time` ms have passed."
)]
#[arg(
    name = "time",
    doc = "The time in milliseconds to wait before calling the callback."
)]
#[ret(
    ty = "CancelHandle",
...
#[lua_func(name = "setInterval", skip = "lua", module = "waypane")]
#[arg(
    name = "callback",
